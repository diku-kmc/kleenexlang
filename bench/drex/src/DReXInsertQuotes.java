...
// DReX version of "drex_insert-quotes"

public class DReXInsertQuotes {

    public static void main(String [] args) {
        int lno = 0;
        long preCompile = System.currentTimeMillis();

        Expression expression = BenchExprs.buildInsertQuotes();
        Evaluator evaluator = BenchmarkEvaluator.getForkjoinEvaluator("drex_insert-quotes", expression);
