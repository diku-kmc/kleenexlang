...
// DReX version of "drex_del-comments"

public class DReXDeleteComments {

    public static void main(String [] args) {
        int lno = 0;
        long preCompile = System.currentTimeMillis();

        Expression expression = BenchExprs.buildDeleteComments();
        Evaluator evaluator = BenchmarkEvaluator.getForkjoinEvaluator("drex_del-comments", expression);
